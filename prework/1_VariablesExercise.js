...
// num2 but not num1?
// The difference between the two is the comparison operators used. For num1 > and < are used while for num2 >= and <= is used.
// The equal two operator allows for value to be equal to the number it is being compared two while without it the value can only be greater or less than the number. 
//Values that would be valid for num2 but not num1 are 1 and 10. 
...
// I found it pretty easy and I used replit to debug/check my answers
