...
function exercise2(num2) {
  ...
  // --------------------------------------------
if (num2 % 2 == 0){
  return answer2 = `${num2} is even`
}else if (num2 % 2 == 1){
  return answer2 = `${num2} is odd`
}
  // --------------------------------------------
  // And above here
  // --------------------------------------------
...
//You can do a number string and it can equal an equation but you can't write the equation as a string. For example, '7' and 6+1 are equal but '7' and '6+1" (as a string) are not. 
...
switch (typeof item) {
  ...
  case item = 1000000:
      answer9 =  "You are one in a million!";
        break;
case item = "string":
    return answer9 = "Please send a number, that was a String";
        break;
case item = "boolean":
    return answer9 = "Please send a number, that was a boolean";
        break; 
 default:
...
// It wasn't too hard but I did struggle with number 9. 
